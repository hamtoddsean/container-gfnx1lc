...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gfnx1lc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gfnx1lc.containers.anotherwebservice.com/
...
```
git clone git@github.com:hamtoddsean/container-gfnx1lc.git
cd container-gfnx1lc
```
...
```
docker attach container-gfnx1lc
```
